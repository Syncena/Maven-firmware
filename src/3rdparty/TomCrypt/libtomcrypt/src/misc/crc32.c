...
void crc32_init(crc32_state *ctx) __attribute__ ((weak));
...
void crc32_update(crc32_state *ctx, const unsigned char *input, unsigned long length) __attribute__ ((weak));
...
void crc32_finish(crc32_state *ctx, void *hash, unsigned long size) __attribute__ ((weak));
